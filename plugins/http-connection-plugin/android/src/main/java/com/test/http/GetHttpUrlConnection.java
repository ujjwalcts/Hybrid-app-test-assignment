...
public class GetHttpUrlConnection implements IConnection {

    private final HttpURLConnection connection;

    /**
     * Make a new GetHttpUrlConnection instance, which wraps around HttpUrlConnection
     ...
     */
    public GetHttpUrlConnection(HttpURLConnection conn) {
        connection = conn;
